      ...
      <div class="row ma-10">
        <v-action>
          <v-btn
            depressed
            color="primary"
            :to="'/adminproduk/' + this.$route.params.no"
            class="text-md-h6"
          >
            KEMBALI<v-icon>mdi-close</v-icon>
          </v-btn>
        </v-action>
        <v-row class="text-center ml-16">
          <h3>{{ listProduk.nama }}</h3>
        </v-row>
      </div>
              ...
              <v-card ref="form">
                <v-card-text>
                  ...
                  <v-text-field
                    ref="harga"
                    v-model="form.harga"
                    :rules="[() => !!form.harga || 'This field is required']"
                    label="Harga Produk"
                  ...
                  <v-text-field
                    ...
                    :rules="[
                      () => !!form.deskripsi || 'This field is required',
                    ]"
                  ...
                  <v-textarea
                    ...
                    :rules="[
                      () => !!form.spesifikasi || 'This field is required',
                    ]"
                  ></v-textarea>
                  <v-text-field
                    ref="stock"
                  ...
                  <v-text-field
                    ...
                    :rules="[
                      () => !!form.gambar_utama || 'This field is required',
                    ]"
                    label="Gambar Produk"
                    required
                  ...
                  <v-text-field
                    ...
                    :rules="[
                      () => !!form.hasil_penjualan || 'This field is required',
                    ]"
                ...
                <v-card-actions>
                  ...
                  <v-btn color="primary" text @click="updateProduk()">
                    Submit
                  </v-btn>
                </v-card-actions>
              </v-card>
  ...
  methods: {
    updateProduk() {
      Vue.axios
        ...
        // })
        .post("http://localhost/galaxyphone/api/produk/update.php", this.form)
        .then(() => {
